...
## Pmod Header JC
set_property -dict {PACKAGE_PIN U15 IOSTANDARD LVCMOS33} [get_ports CSn]
set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports MOSI]
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports MISO]
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports SCK]
